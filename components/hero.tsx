    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-100 to-teal-50 flex items-center px-6 py-16 font-sans">
        <div className="max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="flex-1 max-w-xl">
            <h1 className="text-5xl lg:text-6xl font-semibold text-slate-900 leading-tight tracking-tight mb-5">
              Get paid early
              <br />
              save automatically
              <br />
        ...
        <div className="mx-auto max-w-6xl rounded-3xl bg-white p-8 shadow-xl md:p-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-7 transition hover:-translate-y-1 hover:bg-white hover:shadow-lg">
              ...
              <p className="text-sm leading-6 text-slate-500">
                Manage balances, invoices, and payouts from one clear dashboard
      ...
      <section className="bg-gradient-to-br from-slate-100 to-teal-50 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <h2 className="mb-12 max-w-2xl text-4xl font-semibold leading-tight text-slate-900 md:text-5xl">
          ...
          <div className="mt-6 rounded-3xl bg-white p-8 shadow-sm lg:p-10">
            <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
              <div>
                ...
                <h3 className="mb-4 max-w-sm text-3xl font-semibold leading-tight text-slate-900">
                  No asset volatility
                </h3>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7 transition hover:-translate-y-1 hover:bg-white/[0.07]">
              ...
              <h3 className="mb-3 text-xl font-semibold">Open your account</h3>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7 transition hover:-translate-y-1 hover:bg-white/[0.07]">
              ...
              <h3 className="mb-3 text-xl font-semibold">Transfer your money</h3>
              <p className="text-sm leading-6 text-slate-400">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-7 transition hover:-translate-y-1 hover:bg-white/[0.07]">
              ...
              <p className="text-sm leading-6 text-slate-400">
                Track your reserve performance and keep cash flow visible as
                your balance grows.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-semibold text-slate-800">Finepay</span>
              </div>
            ...
            <div>
              <h3 className="font-semibold text-base text-slate-800 mb-4">Product</h3>
              <ul className="space-y-2 text-sm text-slate-500">
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Features</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Pricing</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Integrations</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">FAQ</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-base text-slate-800 mb-4">Company</h3>
              <ul className="space-y-2 text-sm text-slate-500">
                <li><a href="#" className="hover:text-[#2a8f9e] transition">About</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Blog</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Careers</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Press</a></li>
              </ul>
            </div>
            <div>
              <h3 className="font-semibold text-base text-slate-800 mb-4">Legal</h3>
              <ul className="space-y-2 text-sm text-slate-500">
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Privacy</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Terms</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Security</a></li>
                <li><a href="#" className="hover:text-[#2a8f9e] transition">Cookies</a></li>
              </ul>
            </div>
          </div>
